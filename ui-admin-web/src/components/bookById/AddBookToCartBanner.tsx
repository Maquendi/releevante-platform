...
export default function AddBookToCartBanner({ book }: AddToCartProps) {
  ...
  return (
    <div
      className={cn(
        "py-4 px-3 flex items-center justify-center gap-4 fixed bottom-0 left-0 right-0 bg-white transition-transform ease-in-out duration-300 min-[1025px]:hidden",
